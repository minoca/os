...
#define E1000_TX_DESCRIPTOR_CONTROL_PREFETCH_THRESHOLD_SHIFT 8
#define E1000_TX_DESCRIPTOR_CONTROL_WRITEBACK_THRESHOLD_SHIFT 16
#define E1000_TX_DESCRIPTOR_CONTROL_WRITEBACK_THRESHOLD_MASK (0x3F << 16)
#define E1000_TX_DESCRIPTOR_CONTROL_DESCRIPTOR_GRANULARITY (1 << 24)
#define E1000_TX_DESCRIPTOR_CONTROL_LOW_THRESHOLD_SHIFT 25
#define E1000_TX_DESCRIPTOR_CONTROL_LOW_THRESHOLD_MASK (0x7F << 25)

#define E1000_TX_DESCRIPTOR_CONTROL_FULL_WRITEBACK \
    (E1000_TX_DESCRIPTOR_CONTROL_DESCRIPTOR_GRANULARITY | \
     (1 << E1000_TX_DESCRIPTOR_CONTROL_WRITEBACK_THRESHOLD_SHIFT))
...
typedef enum _E1000_REGISTER {
    ...
    E1000RxDescriptorControl = 0x2828,
