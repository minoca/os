...
Abstract:
    ...
    This module implements the NULL driver.
...

{
    ...
    FunctionTable.AddDevice = NullAddDevice;
    FunctionTable.DispatchStateChange = NullDispatchStateChange;
    FunctionTable.DispatchOpen = NullDispatchOpen;
    FunctionTable.DispatchClose = NullDispatchClose;
    FunctionTable.DispatchIo = NullDispatchIo;
    FunctionTable.DispatchSystemControl = NullDispatchSystemControl;
