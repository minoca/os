...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketCreatePair);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketCreate);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketBind);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketListen);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketAccept);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketConnect);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketPerformVectoredIo);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketGetSetInformation);
...

{
    ...
    ASSERT(SystemCallNumber == SystemCallSocketShutdown);
