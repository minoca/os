...
Members:
    ...
    Status - Stores the result of the system call. Since on success the system
        call never returns as the entire address space is wiped and replaced
        with the running image, this parameter would only be populated by the
        kernel on failure.
