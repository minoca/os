...

{
    ...
    Context.WriteWideCharacter = RtlpStringFormatWriteCharacterWide;
...

{
    ...
    ASSERT((Context != NULL) && (Context->WriteWideCharacter != NULL) &&
...

{
    ...
    Result = Context->WriteWideCharacter(Character, Context);
    if (Result == FALSE) {
        return FALSE;
    }
