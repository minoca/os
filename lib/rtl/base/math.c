...

{
    ...
    return RtlCountTrailingZeros32(Portion) + Extra + 1;
}
...

{
    ...
    return RtlCountTrailingZeros32(Value) + 1;
}
...

{
    ...
    return 64 - RtlCountLeadingZeros64(Value);
}
...

{
    ...
    return 32 - RtlCountLeadingZeros32(Value);
}
