...
genffs -s -i integrt -r EFI_SECTION_PE32 \
    -i integrt -r EFI_SECTION_USER_INTERFACE -t EFI_FV_FILETYPE_DRIVER \
    -o $WORK_DIR/integrt.ffs

cp $SRCROOT/$ARCH$DEBUG/obj/os/uefi/plat/integcp/acpi/acpi.ffs $WORK_DIR
...
ORIGINAL_DIR=`pwd`
cd ${WORK_DIR}
genfv -o ${OUTPUT} rtbase.ffs integrt.ffs acpi.ffs
