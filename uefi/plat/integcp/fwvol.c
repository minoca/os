...
extern UINT8 _binary_integfwv_start;
extern UINT8 _binary_integfwv_end;
...

{
    ...
    Base = (EFI_PHYSICAL_ADDRESS)(UINTN)&_binary_integfwv_start;
    Size = (UINTN)&_binary_integfwv_end - (UINTN)&_binary_integfwv_start;
