...
extern UINT8 _binary_rpi2fwv_start;
extern UINT8 _binary_rpi2fwv_end;
...

{
    ...
    Base = (EFI_PHYSICAL_ADDRESS)(UINTN)&_binary_rpi2fwv_start;
    Size = (UINTN)&_binary_rpi2fwv_end - (UINTN)&_binary_rpi2fwv_start;
