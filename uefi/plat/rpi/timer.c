...
Abstract:
    ...
    This module implements platform timer services for the Raspberry Pi.
...

{
    ...
    // The Raspberry Pi's APB clock frequency is fixed and can achieve the
    ...
    *ClockTimerServiceRoutine = EfipPlatformServiceTimerInterrupt;
    Predivider = RASPBERRY_PI_BCM2835_TIMER_PREDIVIDER_VALUE;
