...
Abstract:
    ...
    This module implements platform interrupt support for the Raspberry Pi.

Author:

    Chris Stevens 26-Dec-2014
...

{
    ...
    Status = EfipBcm2709InterruptInitialize();
    if (EFI_ERROR(Status)) {
        return Status;
    }
...

{
    ...
    Status = EfipBcm2709InterruptSetInterruptLineState(LineNumber,
                                                       Enabled,
                                                       EdgeTriggered);
...

{
    ...
    EfipBcm2709InterruptBeginInterrupt(InterruptNumber, InterruptContext);
    return;
}
...

{
    ...
    EfipBcm2709InterruptEndInterrupt(InterruptNumber, InterruptContext);
    return;
}
