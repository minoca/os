...
#define RK32_SD_INTERRUPT_MASK_DATA_NO_BUSY_DISABLE       (1 << 16)
...
#define RK32_SD_INTERRUPT_MASK_DEFAULT                   \
    (RK32_SD_INTERRUPT_MASK_SDIO |                       \
     RK32_SD_INTERRUPT_MASK_ERROR_END_BIT |              \
     RK32_SD_INTERRUPT_MASK_AUTO_COMMAND_DONE |          \
     RK32_SD_INTERRUPT_MASK_ERROR_START_BIT |            \
     RK32_SD_INTERRUPT_MASK_ERROR_HARDWARE_LOCKED |      \
     RK32_SD_INTERRUPT_MASK_ERROR_FIFO_UNDERRUN |        \
     RK32_SD_INTERRUPT_MASK_ERROR_HOST_TIMEOUT |         \
     ...
     RK32_SD_INTERRUPT_MASK_RECEIVE_FIFO_DATA_REQUEST |  \
     RK32_SD_INTERRUPT_MASK_TRANSMIT_FIFO_DATA_REQUEST | \
     RK32_SD_INTERRUPT_MASK_DATA_TRANSFER_OVER |         \
     RK32_SD_INTERRUPT_MASK_COMMAND_DONE |               \
     RK32_SD_INTERRUPT_MASK_ERROR_RESPONSE |             \
     RK32_SD_INTERRUPT_MASK_CARD_DETECT)
